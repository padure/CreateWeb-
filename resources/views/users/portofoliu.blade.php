            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <ul class="list-inline">
                    <li>Data: January 2017</li>
                    <li>Client: Explora</li>
                    <li>Categorie: Design grafic</li>
                  </ul>
                  <button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fa fa-times"></i>
                    Închideți Proiectul</button>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <ul class="list-inline">
                    <li>Data: January 2017</li>
                    <li>Client: Finalizarea</li>
                    <li>Categorie: Identitate</li>
                  </ul>
                  <button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fa fa-times"></i>
                    Închideți Proiectul</button>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <ul class="list-inline">
                    <li>Data: January 2017</li>
                    <li>Client: Sud-Vest</li>
                    <li>Categorie: Proiectare de site-uri</li>
                  </ul>
                  <button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fa fa-times"></i>
                    Închideți Proiectul</button>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <ul class="list-inline">
                    <li>Data: January 2017</li>
                    <li>Client: Fereastră</li>
                    <li>Categorie: Fotografie</li>
                  </ul>
                  <button class="btn btn-primary" data-dismiss="modal" type="button">
                    <i class="fa fa-times"></i>
                    Închideți Proiectul</button>
